...
<!--auto load script course wise ends here-->
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			?>
													<div><!--form start-->
			<form action="index_admin.php#home4" method="post" class="form-horizontal" role="form">
...
?>
		...
		<!--script ends for live table-->	
			...
			?>
													...
													<div><!--form start-->
			<form action="index_admin.php#profile4" method="post" class="form-horizontal" role="form">
				...
				<td><?php echo $row1['num_tests_passed']; ?></td>
					...
					?>
												...
												<div id="dropdown14" class="tab-pane">
													<div class="row">
													<div><!--form div-->
													<form action="index_admin.php#dropdown14" method="post" class="form-horizontal" role="form">
									<div>				
