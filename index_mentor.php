...
$sql = "Select * from mentor_mentis where username='$username'";
...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
							...
							<div class="col-sm-12">
										<div class="tabbable">
											<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
												<li class="active">
													<a data-toggle="tab" href="#home4">Search by user</a>
												</li>

												<li >
													<a data-toggle="tab" href="#profile4">Search by course</a>
												</li>

												<li>
													<a data-toggle="tab" href="#dropdown14">Search by date</a>
												</li>
											</ul>
			...
			?>
													<div><!--form start-->
			<form action="index_mentor.php#home4" method="post" class="form-horizontal" role="form">
...
?>
		...
		<!--script ends for live table-->	
			...
			?>
													...
													<div><!--form start-->
			<form action="index_mentor.php#profile4" method="post" class="form-horizontal" role="form">
				...
				<td><?php echo $row1['num_tests_passed']; ?></td>
					...
					?>
												...
												<div id="dropdown14" class="tab-pane">
													<div class="row">
													<div><!--form div-->
													<form action="index_mentor.php#dropdown14" method="post" class="form-horizontal" role="form">
									<div>				
...
if(!empty($from_date) && !empty($to_date))
{
	...
	{
		$sql="select s.event_id,e.user_id,u.username,e.problem_id,p.course_id,p.testname,cc.name,cc.title,u.email,t.name,cc.year, s.num_tests_attempted,s.num_tests_passed from cc_events e,cc_users u,cc_submission_receipts s,cc_courses cc,cc_problems p,cc_terms t where cc.id =p.course_id and s.event_id=e.id and u.id=e.user_id and e.problem_id=p.problem_id and t.id=cc.term_id and left(e.timestamp,10) >='$from_date' and left(e.timestamp,10) <='$to_date' limit 10";
	}
	elseif(!empty($course_name) && empty($problem_name))
	{
		$sql="select s.event_id,e.user_id,u.username,e.problem_id,p.course_id,p.testname,cc.name,cc.title,u.email,t.name,cc.year, s.num_tests_attempted,s.num_tests_passed from cc_events e,cc_users u,cc_submission_receipts s,cc_courses cc,cc_problems p,cc_terms t where cc.id =p.course_id and s.event_id=e.id and u.id=e.user_id and e.problem_id=p.problem_id and t.id=cc.term_id and left(e.timestamp,10) >='$from_date' and left(e.timestamp,10) <='$to_date' and p.course_id='$course_id' limit 10";

	}
	elseif(empty($course_name) && !empty($problem_name))
	{
		$sql="select s.event_id,e.user_id,u.username,e.problem_id,p.course_id,p.testname,cc.name,cc.title,u.email,t.name,cc.year, s.num_tests_attempted,s.num_tests_passed from cc_events e,cc_users u,cc_submission_receipts s,cc_courses cc,cc_problems p,cc_terms t where cc.id =p.course_id and s.event_id=e.id and u.id=e.user_id and e.problem_id=p.problem_id and t.id=cc.term_id and left(e.timestamp,10) >='$from_date' and left(e.timestamp,10) <='$to_date' and e.problem_id='$problem_id' limit 10";

	}
	elseif(!empty($course_name) && !empty($problem_name))
	{
		$sql="select s.event_id,e.user_id,u.username,e.problem_id,p.course_id,p.testname,cc.name,cc.title,u.email,t.name,cc.year, s.num_tests_attempted,s.num_tests_passed from cc_events e,cc_users u,cc_submission_receipts s,cc_courses cc,cc_problems p,cc_terms t where cc.id =p.course_id and s.event_id=e.id and u.id=e.user_id and e.problem_id=p.problem_id and t.id=cc.term_id and left(e.timestamp,10) >='$from_date' and left(e.timestamp,10) <='$to_date' and p.course_id='$course_id' and e.problem_id='$problem_id' limit 10";
	}
}	
elseif(empty($from_date) && empty($to_date))
{
	if(!empty($course_name) && empty($problem_name))
	{
		$sql="select s.event_id,e.user_id,u.username,e.problem_id,p.course_id,p.testname,cc.name,cc.title,u.email,t.name,cc.year, s.num_tests_attempted,s.num_tests_passed from cc_events e,cc_users u,cc_submission_receipts s,cc_courses cc,cc_problems p,cc_terms t where cc.id =p.course_id and s.event_id=e.id and u.id=e.user_id and e.problem_id=p.problem_id and t.id=cc.term_id and p.course_id='$course_id' order by event_id DESC limit 10";
	...
	$results = $db_handle->runQuery($sql);												
		?>											
			...
			<!--	<td><?php //echo $row1['event_id'];?></td>-->
				...
				<td><?php echo $result;//echo $table_row['num_tests_attempted']; ?></td>
...
<![endif]-->
		...
		<!-- page specific table plugin scripts -->
